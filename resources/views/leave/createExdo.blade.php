...
<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header">Applying Exdo Leave</h1>
    </div>
</div>
<div class="row">
    <div class="col-lg-12">
    ...
    <div class="col-lg-12">
        <div class="panel panel-primary">
            <div class="panel-body">
                {!! Form::open(['route' => 'leaveExdo/store', 'role' => 'form', 'autocomplete' => 'off']) !!}

                <div class="row">
                    <div class="col-lg-12">
                        <h5>
                            <!-- <b><img style="width:210px; height:60px;" src="{!! URL::route('assets/img/kinema') !!}"></b> -->
                        </h5>
                    </div>
                </div>
                        ...
                        <div class="row">
                            <div class="col-lg-3">
                                ...
                                <div class="col-lg-2">
                                    ...
                                    <div class="form-group has-error">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <sup><a href="#" class="pull-right" title="input the date of back work"><i class="material-icons" style="font-size: 16px; color: red;">&#xe88f;</i></a></sup>
                                            <br>
                                ...
                                @if ($errors->has('total_day'))
                                    <div class="form-group has-error">
                                @else
                                    <div class="form-group" onkeyup="hitung2();">
                                @endif
                                    {!! Form::label('total_day', 'Total Day') !!}<br>
                                    {!! Form::text('total_day', old('total_day'), ['class' => 'form-control', 'required' => true, 'numeric' => true]) !!}
                                    <p class="help-block">{!! $errors->first('total_day') !!}</p>
                                    </div>
                                </div> -->
                                ...
                                @endif
                                    ...
                                    {!! Form::text('taken', $taken, ['class' => 'form-control', 'maxlength' => 100, 'autofocus' => true, 'readonly' => true]) !!}
                                    <p class="help-block">{!! $errors->first('taken') !!}</p>
                                    </div> -->
                                    </div>
                                </div>
                                    ...
                                    <div class="col-lg-2">
                                        ...
                                        <div class="form-group has-error">
                                            ...
                                            <div class="form-group">
                                                ...
                                                {!! Form::text('leave_category_id', 'Exdo', ['class' => 'form-control', 'placeholder' => 'Leave Category', 'maxlength' => 100, 'required' => true, 'readonly' => true]) !!}
                                        ...
                                        <div class="col-lg-1">
                                            <div class="form-group">
                                                {!! Form::label('entitlement', 'Balance') !!}
                                                {!! Form::text('entitlement', $leave, ['class' => 'form-control', 'maxlength' => 100, 'autofocus' => true, 'readonly' => true]) !!}
                                            </div>
                                        </div>
                                ...
                                @endif
                                    ...
                                    {!! Form::text('remain', old('remain'), ['class' => 'form-control', 'maxlength' => 100, 'autofocus' => true, 'required' => true, 'readonly' => true, 'min' => true]) !!}
                                    <p class="help-block">{!! $errors->first('remain') !!}</p>
                                </div>
                            </div> -->
                                    </div>
                                        ...
                                        <div class="col-lg-3">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="nama_provin" required="true" id="ada">
                                                    ...
                                                    <?php foreach ($provinsii as $nama_provinsi) : ?>
                                                        <option value="{{$nama_provinsi['id']}}">{{$nama_provinsi['nama']}}</option>
                                                    <?php endforeach ?>
                                                </select>
                                            </div>
                                        </div>
                                            ...
                                            <div class="form-group">
                                                <?php if (auth::user()->hd === 1) : ?>
                                                    ...
                                                    <select class="form-control" name="sendtoPM" id="sendtoPM" required="true">
                                                        <option value="{{ $assistGM }}">{{ $assistGM }}</option>
                                                    </select>
                                                    @endif
                                ...
                                <div class="row">
                                    <div class="col-lg-3">
                                        <div class="form-group">
                                            ...
                                            {!! Form::textarea('reason', old('reason'), ['class' => 'form-control', 'placeholder' => 'max:50 word', 'maxlength' => 50, 'autofocus' => true, 'autosave' => true, 'style' => 'height:100px;']) !!}
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                ...
                                {!! Form::submit('Apply', ['class' => 'btn btn-sm btn-success', 'data-toggle' => 'modal', 'data-target' => '#modal']) !!}
