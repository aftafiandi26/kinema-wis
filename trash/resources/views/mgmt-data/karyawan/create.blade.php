            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h5 class="panel-title">
                        <b>Form Tambah Data Karyawan</b>
                    </h5>
                </div>

                <div class="panel-body">
                    {!! Form::open(['route' => 'mgmt-data/karyawan/store', 'role' => 'form', 'autocomplete' => 'off']) !!}
                        <div class="row">
                            <div class="col-lg-4">
                                @if ($errors->has('nik'))
                                ...
                                @endif
                					...
                					{!! Form::text('nik', old('nik'), ['class' => 'form-control', 'placeholder' => 'NIK', 'maxlength' => 16, 'autofocus' => true, 'required' => true]) !!}
                            ...
                            <div class="col-lg-4">
                                ...
                                @endif
                                    ...
                                    {!! Form::text('name', old('name'), ['class' => 'form-control', 'placeholder' => 'Name', 'maxlength' => 50, 'required' => true]) !!}
                            ...
                            <div class="col-lg-4">
                                ...
                                @endif
                					...
                					{!! Form::text('alamat', old('alamat'), ['class' => 'form-control', 'placeholder' => 'Alamat', 'maxlength' => 100, 'required' => true]) !!}
                        ...
                        <div class="row">
                            <div class="col-lg-3">
                                ...
                                @endif
                                    ...
                                    {!! Form::select('jenis_kelamin', $jenis_kelamin, old('jenis_kelamin'), ['class' => 'form-control', 'maxlength' => 9, 'required' => true]) !!}
                            ...
                            <div class="col-lg-3">
                                ...
                                @endif
                                    ...
                                    {!! Form::text('tempat_lahir', old('tempat_lahir'), ['class' => 'form-control', 'placeholder' => 'Tempat Lahir', 'maxlength' => 50, 'required' => true]) !!}
                            ...
                            <div class="col-lg-3">
                                ...
                                @endif
                                    ...
                                    {!! Form::text('tanggal_lahir', old('tanggal_lahir'), ['class' => 'form-control', 'placeholder' => 'Tanggal Lahir (dd-mm-yyyy)', 'maxlength' => 10, 'required' => true]) !!}
                            ...
                            <div class="col-lg-3">
                                ...
                                @endif
                                    ...
                                    {!! Form::text('no_telp', old('no_telp'), ['class' => 'form-control', 'placeholder' => 'No. Telepon', 'maxlength' => 12, 'required' => true]) !!}
                        ...
                        <div class="row">
                            <div class="col-lg-3">
                                ...
                                @endif
                                    ...
                                    {!! Form::select('status_perkawinan', $status_perkawinan, old('status_perkawinan'), ['class' => 'form-control', 'maxlength' => 7, 'required' => true]) !!}
                            ...
                            <div class="col-lg-3">
                                ...
                                @endif
                                    ...
                                    {!! Form::select('tempat_tinggal', $tempat_tinggal, old('tempat_tinggal'), ['class' => 'form-control', 'maxlength' => 15, 'required' => true]) !!}
                            ...
                            <div class="col-lg-3">
                                ...
                                @endif
                                    ...
                                    {!! Form::select('cabang', $cabang, old('cabang'), ['class' => 'form-control', 'maxlength' => 30, 'required' => true]) !!}
                            ...
                            <div class="col-lg-3">
                                ...
                                @endif
                                    ...
                                    {!! Form::select('golongan_gaji', $golongan_gaji, old('golongan_gaji'), ['class' => 'form-control', 'maxlength' => 2, 'required' => true]) !!}
