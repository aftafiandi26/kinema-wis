...
<div class="container-fluid">
    <div class="row">
        <div class="col-lg-12" style="margin-left: 0px;">
            ...
            <br>
            <label>Stock Transaction : {{$kategori->kategori_stock}}</label>          
        </div>
    </div>
    <div class="row">
        <div class="col-lg-12"> 
            <table class="table" border="1">
                ...
                <tbody>
                    <?php foreach ($data as $stocks): ?>
                       <tr>
                            <td style="text-align: center;">{{$no++}}</td>   
                            <td style="text-align: center;">{{$stocks->kode_barang}}</td>
                            <td style="text-align: left;">{{$stocks->name_item}}</td>
                            <td style="text-align: center;">{{$stocks->satuan}}</td>
                            <td style="text-align: center;">{{$stocks->merk}}</td>
    ...
    <div class="row" style="margin-top: 100px;">
       <div class="col-lg-4">
            ...
            <p style="text-decoration: underline;">Wira Audika</p>               
