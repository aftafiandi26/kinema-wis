...
class ReminderSoftwareMail extends Mailable
{
    ...
    {
        $getData = AssetSoftware::whereDate('expiring_date', '<=', date('Y-m-d', strtotime("+30 days")))->where('expiring_date', '>=', date('Y-m-d'))->get();
        $id = 30;

        return $this
        ->to('support@frameworks-studios.com') 
