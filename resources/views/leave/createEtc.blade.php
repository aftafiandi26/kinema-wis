    ...
    <div class="col-lg-12">
        <div class="panel panel-info">
            <div class="panel-body">
                {!! Form::open(['route' => 'leaveEtc/store', 'role' => 'form', 'autocomplete' => 'off']) !!}
                        ...
                        <div class="row">
                            <div class="col-lg-3">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-2">
                                        ...
                                        <div class="form-group has-error">
                                            ...
                                            <div class="form-group">
                                                ...
                                                {!! Form::select('leave_category_id', $leave, old('leave_category_id'), ['class' => 'form-control', 'required' => true, 'id' => 'sickness', 'onclick' => 'sickes()']) !!}
                                    ...
                                    <div class="row">
                                        <div class="col-lg-3">
                                            <div class="form-group">
                                                ...
                                                {!! Form::textarea('reason', old('reason'), ['class' => 'form-control', 'placeholder' => 'max:50word', 'maxlength' => 50, 'autofocus' => true, 'autosave' => true, 'style' => 'height:100px;']) !!}
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <!--   <a class="btn btn-sm btn-success" title="Detail" data-toggle="modal" data-target="#showModal" data-post="{{url('LeaveController@DetailStoreLeaveETC')}}">Apply</a> -->
