...
class HRExdoViewController extends Controller
{
    ...
    public function index($id)
    {
        ...
        $indexExdo = Initial_Leave::where('user_id', $id)->where('expired', '>', date('Y-m-d'))->orderBy('expired', 'asc')->paginate(5);
        ...
        return view('HRDLevelAcces/leave/exdo/viewExdo/index', compact(['user', 'dept', 'indexExdo', 'no', 'exdoTransaction', 'sisaExdo', 'remains', 'totalExdo']));
    }
