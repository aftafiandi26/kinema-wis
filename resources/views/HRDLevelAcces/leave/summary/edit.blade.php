                    ...
                    <div class="row">
                        <div class="col-lg-2">
                            <div class="form-group">
                                ...
                                <input type="text" name="endDate" id="endDate" class="form-control" value="@if ($data->end_date)
                                    {{ $data->end_date }} @else --
                                @endif" readonly>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-2">
                            <div class="form-group">
                                ...
                                <input type="text" name="available" id="available" class="form-control" value="{{ $advancedLeaveAnnual }}" required>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-lg-2">
                            <div class="form-group">
                                ...
                                <input type="text" name="exdo" id="exdo" value="{{ $advanceExdo }}" class="form-control">
                            </div>
                        </div>
                    </div>
                    <div class="row">
