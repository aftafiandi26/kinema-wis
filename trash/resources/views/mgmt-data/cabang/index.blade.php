...
@section('body')
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Data Cabang</h1>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-lg-12">
			<div align="right">
				<a style="margin-bottom: 15px;" class="btn btn-sm btn-primary" data-original-title="Tambah" data-toggle="tooltip" data-placement="top" href="{!! URL::route('mgmt-data/cabang/create') !!}"><span class="fa fa-plus"></span></a>
			</div>
...
@section('script')
    ...
    $('#tables').DataTable({
        ...
        responsive: true,
        ajax: '{!! URL::route("mgmt-data/cabang/getindex") !!}'
    });
@stop