<div class="navbar-default sidebar" role="navigation" style="margin-top: 80px">
    <div class="sidebar-nav navbar-collapse">
        <ul class="nav" id="side-menu">
            <li>
                ...
                <a style="color: black">
                    ...
                    @if (Auth::user()->prof_pict !== null)
                    <a style="color: black">
                        <img src="{{ asset('storage/app/public/prof_pict/'.Auth::user()->prof_pict.'') }}" class="img-circle" style="width: 50px; height: 50px;" alt="">
                        <i>&nbsp&nbsp Hi, <b>{!! Auth::user()->first_name !!}</b></i>
                        @endif
                    </a>
            </li>
            ...
            <li>
                ...
                <ul class="nav nav-second-level {!! $c1u or '' !!}">
                    ...
                    @if (Auth::user()->hd === 1)
                    <li>
                        <a class="{!! $c16 or '' !!}" href="{!! URL::route('leave/HD_approval') !!}"><i class="fa fa-fw fa fa-genderless"></i> Leave Approval <br> <i>(<?php $dept =  DB::table('dept_category')->where('dept_category.id', '=', Auth::user()->dept_category_id)->value('dept_category_name'); echo $dept; ?> Department)</i></a>
                    </li>
                        @if (auth::user()->dept_ApprovedHOD === 1 && auth::user()->dept_category_id === 2)
                            <li>
                                <a class="{!! $c16 or '' !!}" href="{!! URL::route('head-of-approval/index') !!}"><i class="fa fa-fw fa fa-genderless"></i> Leave HOD Approval </a>
                            </li>
                        @endif
        ...
        @endif
        <li>
            <a class="{!! $c30001 or '' !!}" href="{!! URL::route('indexAbsensi') !!}"><i class="fa fa-fw fa fa fa-bar-chart"></i> Attendance
            </a>
        </li>
        @if(auth::user()->dept_category_id === 3)
        <li>
            <a class="{!! $c3 or '' !!}" href=""><i class="fa fa-fw fa fa-soundcloud"></i> Summary<span class="fa arrow"></span></a>
            <ul class="nav nav-second-level {!! $c1u or '' !!}">
                <li>
        ...
        <li>
            ...
            <ul class="nav nav-second-level {!! $c1u or '' !!}">
                <li>
                    <a class="{!! $c16 or '' !!}" href="{!! URL::route('indexIT') !!}"><i class="fa fa-fw fa fa-genderless"></i> List Workstation</a>
                </li>
                <li>
                    <a class="{!! $c16 or '' !!}" href="{!! URL::route('idle') !!}"><i class="fa fa-fw fa fa-genderless"></i> Idle Workstation</a>
                </li>
                <li>
                    <a class="{!! $c16 or '' !!}" href="{!! URL::route('legend') !!}"><i class="fa fa-fw fa fa-genderless"></i> Legend Availability</a>
                </li>
                <li>
                    <a class="{!! $c16 or '' !!}" href="{!! URL::route('scrapped') !!}"><i class="fa fa-fw fa fa-genderless"></i> Scrapped Workstation</a>
                </li>
                <li>
                    <a class="{!! $c16 or '' !!}" href="{!! URL::route('failed') !!}"><i class="fa fa-fw fa fa-genderless"></i> failed Workstations</a>
                </li>
                <li>
        ...
        @if(auth::user()->position === "Junior Programmer")
        <li>
        ...
        <li>
            ...
            <ul class="nav nav-second-level {!! $c1u or '' !!}">
                <li>
                    <a class="{!! $c16 or '' !!}" href="{!! URL::route('indexWS_AvailabilityPipeline') !!}"><i class="fa fa-fw fa fa-genderless"></i> List Workstation</a>
                </li>
                <li>
                    <a class="{!! $c16 or '' !!}" href="{!! URL::route('index_idle_AvabilityPipeline') !!}"><i class="fa fa-fw fa fa-genderless"></i> Idle Workstation</a>
                </li>
                <li>
                    <a class="{!! $c16 or '' !!}" href="{!! URL::route('indexLegendAvailabilityPipeline') !!}"><i class="fa fa-fw fa fa-genderless"></i> Legend Availability</a>
                </li>
                <li>
                    <a class="{!! $c16 or '' !!}" href="{!! URL::route('index_ScrappedPipeline') !!}"><i class="fa fa-fw fa fa-genderless"></i> Scrapped Workstation</a>
                </li>
            </ul>
        </li>
        @endif
        ...
        <li>
            ...
            <ul class="nav nav-second-level {!! $c1u or '' !!}">
                <li>
                    <a class="{!! $c16 or '' !!}" href="{!! URL::route('indexWS_AvailabilityManager') !!}"><i class="fa fa-fw fa fa-genderless"></i> List Workstation</a>
                </li>
                <li>
                    <a class="{!! $c16 or '' !!}" href="{!! URL::route('index_idle_AvabilityManager') !!}"><i class="fa fa-fw fa fa-genderless"></i> Idle Workstation</a>
                </li>
                <li>
                    <a class="{!! $c16 or '' !!}" href="{!! URL::route('indexLegendAvailabilityManager') !!}"><i class="fa fa-fw fa fa-genderless"></i> Legend Availability</a>
                </li>
                <li>
                    <a class="{!! $c16 or '' !!}" href="{!! URL::route('index_ScrappedManager') !!}"><i class="fa fa-fw fa fa-genderless"></i> Scrapped Workstation</a>
                </li>
            </ul>
        </li>
        @endif
        @if(auth::user()->hr === 1)
        <li>
            <a class="{!! $c3 or '' !!}" href="#"><i class="fa fa-fw fa fa-upload"></i> Stationery<span class="fa arrow"></span></a>
            <ul class="nav nav-second-level {!! $c1u or '' !!}">
                <li>
                    <a class="{!! $c16 or '' !!}" href="{!! URL::route('Statoonery/index') !!}"><i class="fa fa-fw fa fa-genderless"></i> Stationery Stock</i></a>
                </li>
                <li>
                    <a class="{!! $c16 or '' !!}" href="{!! URL::route('indexStockStationaryWater') !!}"><i class="fa fa-fw fa fa-genderless"></i> Mineral Stock</i></a>
                </li>
                <li>
        ...
        @if (Auth::user()->hr === 1)
        <li>
            <a class="{!! $c3 or '' !!}" href="#"><i class="fa fa-fw fa-home"></i> Rusun <i>(hr)</i><span class="fa arrow"></span></a>
            <ul class="nav nav-second-level {!! $c1u or '' !!}">
                <li>
                    <a class="{!! $c16 or '' !!}" href="{!! URL::route('hr_mgmt-data/rusunReport') !!}"><i class="fa fa-fw fa fa-genderless"></i> Rusun Report</a>
                </li>
            </ul>
        </li>
        <li>
        ...
        <li>
            ...
            <ul class="nav nav-second-level {!! $c1u or '' !!}">
                <li>
                    <a class="{!! $c30003 or '' !!}" href="{!! URL::route('indexHrAttendace') !!}"><i class="fa fa-fw fa fa-genderless"></i> Summary</a>
                </li>
            </ul>
        </li>
        @endif
        ...
        <li>
            <a class="{!! $c1 or '' !!}" href="{{route('guided')}}" style="color: red;"><i class="fa fa-fw fa fa-book"></i> Booklet</a>
        </li>
        </ul>
