            ...
            foreach ($kategori as $kate): ?>
             <tr>
                ...
                <td style="text-align: center;"><a href="{{route('GeneratePDFNameKategori', [$kate->id])}}" target="_blank" style="color: red; text-decoration: underline;">{{$kate->kategori_stock}}</a></td>
                    <?php 
                        $kacau = stationary_stock::where('kode_kategory', '=', $kate->unik_kategori)->orderBy('kode_barang', 'asc')->get();                      
                        ...
                        <tr>
                            ...
                            <td style="text-align: center;"><b>{{$kacauu->balance_stock}}</b></td>
                            ...
                            <td><a href="{{route('editStationaryName', [$kacauu->id])}}" class="btn btn-sm btn-default">Edit Item</a></td>
                            <td></td>
                        </tr>
                    <?php endforeach ?>
            </tr>
