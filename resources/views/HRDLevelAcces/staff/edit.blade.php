...
@section('body')
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Change Data Employee</h1>
        </div>
    </div>
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    {!! Form::open(['route' => ['updateEmployee', $users->id], 'role' => 'form', 'autocomplete' => 'off', 'enctype' => 'multipart/form-data']) !!}
                    {{ csrf_field() }}
                        <div class="row">
                            <div class="col-lg-2">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2">
                                ...
                                @endif
                                    ...
                                    {!! Form::select('province', $Province, $users->province, ['class' => 'form-control']) !!}
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2">
                                ...
                                @endif
                                    ...
                                    {!! Form::select('education', $education, $users->education, ['class' => 'form-control']) !!}
                          ...
                          <!--  <div class="col-lg-2">
                            ...
                            <div class="col-lg-2">
                                ...
                                @endif
                                  ...
                                  {!! Form::select('religion', $religion, $users->religion, ['class' => 'form-control']) !!}
