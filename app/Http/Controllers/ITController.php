...
class ITController extends Controller
{
	...
	public function index_asset_IT()
	{
		...
		return Datatables::of($select)
			...
			->add_column(
				'action',
				Lang::get('messages.btn_warning', ['title' => 'Edit Workstation', 'url' => '{{ URL::route(\'edit-Asset\', [$id]) }}', 'class' => 'pencil'])
					. Lang::get('messages.btn_print', ['title' => 'Print', 'url' => '{{ URL::route(\'print-asset\', [$id]) }}', 'class' => 'print'])
					. Lang::get('messages.btn_success', ['title' => 'Detail', 'url' => '{{ URL::route(\'DetailAssett\', [$id]) }}', 'class' => 'file'])
					. Lang::get('messages.btn_info', ['title' => 'Embedded', 'url' => '{{ URL::route(\'embeddedAsset\', [$id]) }}', 'class' => 'file'])
			)
			->make();
	}
	...
	public function add_asset_IT()
	{
		...
		$category_type    = ['0' => '- Select Category Type -', '1' => 'Hardware', '2' => 'Tools', '3' => 'Equipment', '4' => 'Software'];

		$category_name    = ['0' => '- Select Category Name -', '1' => 'Switch', '2' => 'Server', '3' => 'Storage', '4' => 'Printer', '5' => 'Wacom', '6' => 'VGA', '7' => 'HDD External & Internal', '8' => 'HBA Card', '9' => 'Render Farm', '10' => 'UPS', '11' => 'Monitor', '12' => 'Laptop', '13' => 'KVMX', '14' => 'Scanner', '15' => 'Wireless', '16' => 'VOIP', '17' => 'Workstation', '18' => 'Projector', '19' => 'Enclosure', '20' => 'Other'];

		/*  $status = ['0' => '-Select Status Item-', 'FAILED' => 'FAILED', 'SCRAPPED' => 'SCRAPPED', 'OK' => 'OK', 'Other' => 'Other'];*/
		$instansi_name = ['' => '- Select Instansi -', '1' => 'Kinema Animasi', '2' => 'Kinema Production Services', '3' => 'Infinite Learning'];
	...
	public function store_add_asset_IT_123(Request $request)
	{
		...
		$data = [
			...
			'barcode_id'            => $request->input('dept') . $request->input('asset_type') . $request->input('asset_category') . $request->input('category_type') . date('y', strtotime($date_incoming)) . $request->input('category_name'),
		...
		$bac =  auth::user()->dept_category_id . $request->input('asset_type') . $request->input('asset_category') . $request->input('category_type') . date('y', strtotime($request->input('incoming'))) . $request->input('category_name');
	...
	public function edit_Asset_IT(Request $request, $id)
	{
		...
		$category_name    = ['0' => '- Select Category Name -', '17' => 'Workstation', '1' => 'Switch', '2' => 'Server', '3' => 'Storage', '4' => 'Printer', '5' => 'Wacom', '6' => 'VGA', '7' => 'HDD External & Internal', '8' => 'HBA Card', '9' => 'Render Farm', '10' => 'UPS', '11' => 'Monitor', '12' => 'Laptop', '13' => 'KVMX', '14' => 'Scanner', '15' => 'Wireless', '16' => 'VOIP', '18' => 'Projector', '19' => 'Enclosure', '20' => 'Other'];
		$instansi_name = ['' => '- Select Instansi -', '1' => 'Kinema Animasi', '2' => 'Kinema Production Services', '3' => 'Infinite Learning'];
	...
	{
		$ss = DB::table('asseting_barcode')->select('*')->where('category_name', '=', $request->input('category_name'))->where('embedded', '=', 0)->get();
				...
				if ($data->count()) {
					foreach ($data as $key => $value) {
						...
						$arr[] = [
							...
							'vendor'                => $value->vendor,
							'status'                => $value->status,
							'barcode_id'            => '1' . $value->asset_type_id . $value->asset_category_id . $value->category_type_id . date('y', strtotime($value->date_incoming)) . $value->category_name,
							/* 'barcode_id'            => '1'.$value->asset_type_id.$value->asset_category_id.$value->category_type_id.'00'.$value->category_name,*/
							'created_name'            => auth::user()->first_name . ' ' . auth::user()->last_name,
							'update_by'              => auth::user()->first_name . ' ' . auth::user()->last_name,
							'created_date'             => date('Y-m-d'),
							'updated_date'              => date('Y-m-d'),
						];
						/*$c = '1'.$value->asset_type_id.$value->asset_category_id.$value->category_type_id.date('y', strtotime($value->date_incoming)).$value->category_name;
	...
	public function embeddedAsset($id)
	{
		...
		$asset_category    = ['0' => '- Select Asset Type -', '1' => 'Asset', '2' => 'Integrable Asset'];
		$category_type    = ['0' => '- Select Category Type -', '1' => 'Hardware', '2' => 'Tools', '3' => 'Equipment'];
		$category_name    = ['0' => '- Select Category Name -', '17' => 'Workstation', '1' => 'Switch', '2' => 'Server', '3' => 'Storage', '4' => 'Printer', '5' => 'Wacom', '6' => 'VGA', '7' => 'HDD External & Internal', '8' => 'HBA Card', '9' => 'Render Farm', '10' => 'UPS', '11' => 'Monitor', '12' => 'Laptop', '13' => 'KVMX', '14' => 'Scanner', '15' => 'Wireless', '16' => 'VOIP', '18' => 'Projector', '19' => 'Enclosure'];
		$instansi_name = ['' => '- Select Instansi -', '1' => 'Kinema Animasi', '2' => 'Kinema Production Services', '3' => 'Infinite Learning'];
	...
	{
		$category_name    = ['0' => '- Select Category Name -', '1' => 'Switch', '2' => 'Server', '3' => 'Storage', '4' => 'Printer', '5' => 'Wacom', '6' => 'VGA', '7' => 'HDD External & Internal', '8' => 'HBA Card', '9' => 'Render Farm', '10' => 'UPS', '11' => 'Monitor', '12' => 'Laptop', '13' => 'KVMX', '14' => 'Scanner', '15' => 'Wireless', '16' => 'VOIP', '17' => 'Workstation', '18' => 'Projector', '19' => 'Enclosure'];
	...
	public function getAssetPS()
	{
		...
		return Datatables::of($select)
			->edit_column('barcode_id', '{{$instansi_id.$barcode_id.$id}}')
			->edit_column('instansi_id', '@if($instansi_id === 1){{"Kinema Animasi"}} @elseif($instansi_id === 2){{"Kinema Production Services"}} @elseif($instansi_id === 3){{"Infinite Learning"}} @else {{"--"}} @endif')
			->edit_column('category_name', '@if($category_name === "17"){{"Workstation"}} @elseif($category_name === "1"){{"Switch"}} @elseif($category_name === "2"){{"Server"}} @elseif($category_name === "3"){{"Storage"}} @elseif($category_name === "4"){{"Printer"}} @elseif($category_name === "5"){{"Wacom"}} @elseif($category_name === "6"){{"VGA"}} @elseif($category_name === "7"){{"HDD External & Internal"}} @elseif($category_name === "8"){{"HBA Card"}} @elseif($category_name === "9"){{"Render Farm"}} @elseif($category_name === "10"){{"UPS"}} @elseif($category_name === "11"){{"Monitor"}} @elseif($category_name === "12"){{"Laptop"}} @elseif($category_name === "13"){{"KVMX"}} @elseif($category_name === "14"){{"Scanner"}} @elseif($category_name === "15"){{"Wireless"}} @elseif($category_name === "16"){{"VOIP"}} @elseif($category_name === "18"){{"Projector"}} @elseif($category_name === "19"){{"Enclosure"}} @else {{"--"}} @endif')
			->edit_column('date_incoming', ' {{date("M, d Y", strtotime($date_incoming))}}')
			->edit_column('asset_type_id', '@if ($asset_type_id === 1){{ "Purchase" }}@elseif($asset_type_id === 2){{ "Transfer" }}@else{{"-"}}@endif')
			...
			->add_column(
				'action',
				Lang::get('messages.btn_warning', ['title' => 'Edit Asset PS', 'url' => '{{ URL::route(\'editAssetPS\', [$id]) }}', 'class' => 'pencil'])
					. Lang::get('messages.btn_print', ['title' => 'Print', 'url' => '{{ URL::route(\'printAssetPS\', [$id]) }}', 'class' => 'print'])
					. Lang::get('messages.btn_success', ['title' => 'Detail', 'url' => '{{ URL::route(\'DetailAssett\', [$id]) }}', 'class' => 'file'])
					. Lang::get('messages.btn_info', ['title' => 'Embedded', 'url' => '{{ URL::route(\'embeddedAsset\', [$id]) }}', 'class' => 'file'])
			)
			->make();
