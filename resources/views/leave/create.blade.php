...
<div class="row">
    <div class="col-lg-12">
                        ...
                        <div class="row">
                            <div class="col-lg-3">
                                ...
                                @endif
                                    ...
                                    {!! Form::text('leave_day', old('leave_day'), ['class' => 'form-control', 'numeric' => true, 'readonly' => true, 'id' => 'totalDay']) !!}
                                    <p class="help-block">{!! $errors->first('total_day') > 0!!}</p>
                                    </div>
                                ...
                                @endif
                                     ...
                                     <label for="halfday" style="color: red;"> + Half Day</label>
                                     <input type="text" name="text" id="hari" class="form-control" readonly value="0">
        ...
        <script type="text/javascript">
            ...
            $('#halfday').change(function(e) {
                e.preventDefault();
                var totalday = $('#hari').val();
