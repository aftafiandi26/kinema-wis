...
/* cek modal untuk self declaertion*/
    ...
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Applying Annual Leave <sup style="color: red;">(advanced)</sup>
			</h1>
        </div>
    </div>
<div class="row">
        ...
        <div class="col-lg-12">
            <div class="panel panel-danger">
                <div class="panel-body">
                    {!! Form::open(['route' => 'advancedLeave/store', 'role' => 'form', 'autocomplete' => 'off']) !!}
                    ...
                    <div class="row">
                        ...
                        <div class="row">
		                   ...
		                   <!--  <div class="col-lg-1">
                                ...
                                @endif
                                    ...
                                    <p class="help-block">{!! $errors->first('total_day') > 0!!}</p>
                                    </div>
                                ...
                                @else
                                    <div class="form-group">
                                @endif
                                    {!! Form::label('leave_day', 'Total Day') !!}<br>
                                    {!! Form::text('leave_day', old('leave_day'), ['class' => 'form-control', 'numeric' => true, 'readonly' => true]) !!}
                                    <p class="help-block">{!! $errors->first('total_day') > 0!!}</p>
                                    </div>
                          ...
                          <!--   <div class="col-lg-1">
                            ...
                            <!-- <div class="col-lg-1">
                                ...
                                @endif
                                    ...
                                    {!! Form::text('remain', old('remain'), ['class' => 'form-control', 'maxlength' => 100, 'autofocus' => true, 'required' => true, 'readonly' => true]) !!}
                       ...
                       <!--  {!! Form::submit('Apply', ['class' => 'btn btn-sm btn-success']) !!} -->
                        <!-- {!! Form::submit('Apply', ['class' => 'btn btn-sm btn-info', 'data-toggle' => 'modal', 'data-target' => '#modal']) !!} -->
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <div class="modal-title">
                        <p><center><h3><b>eForm Self Declaration</b></h3></center></p>
                    </div>
                </div>
