...
class ReminderSoftware60 extends Mailable
{
    ...
    {
       $getData = AssetSoftware::whereDate('expiring_date', '<=', date('Y-m-d', strtotime("+60 days")))->where('expiring_date', '>=', date('Y-m-d'))->get();
       $id = 60;
