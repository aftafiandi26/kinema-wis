...
<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header">Applying Annual Leave
        </h1>
    </div>
</div>
<div class="row">
                            ...
                            <div class="col-lg-3">
                                ...
                                <div class="col-lg-2">
                                    ...
                                    <div class="form-group has-error">
                                        ...
                                        <div class="form-group">
                                            @endif
                                            {!! Form::label('back_work', 'Back to Work at') !!}
								...
								-->
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-2">
                                            ...
                                            <div class="col-lg-1">
                                                <div class="form-group">
                                                    <label id="entitlement">Balance <sup>(monthly)</sup></label>
                                    ...
                                    <p class="help-block">{!! $errors->first('remain') !!}</p>
                                        ...
                                        <?php else : ?>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-3">
                                                    <div class="form-group">
                                                        {!! Form::label('sendtoPM', 'Head of Department :') !!}
                                                        {!! Form::select('sendtoPM', $emailHOD, old('sendtoPM'), ['class' => 'form-control', 'required' => true]) !!}
                                                    </div>
                                                </div>
                                                <div class="col-lg-9">
